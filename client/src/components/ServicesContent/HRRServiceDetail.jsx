        ...
        >
          ...
          >
            <div className="order-2 md:order-1 relative  ">
              ...
              >
                <img 
                  src="https://images.unsplash.com/photo-1600121848594-d8644e57abab?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
            ...
            <div className="order-1 md:order-2  ">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="!px-8 !py-3 bg-[#5c7c3b] text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-shadow  "
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6  ">
              {[
                { 
                  ...
                  before: "https://images.unsplash.com/photo-1556911220-bff31c812dba?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
                  after: "https://images.unsplash.com/photo-1600585152220-90363fe7e115?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"
                },
                { 
                  title: "Exterior Makeover", 
                  before: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
                  after: "https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"
                },
                { 
                  title: "Basement Conversion", 
                  before: "https://images.unsplash.com/photo-1595526114035-0d45a16a0d05?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
                  after: "https://images.unsplash.com/photo-1600121848594-d8644e57abab?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"
                }
              ].map((project, index) => (
                <motion.div
                  key={index}
          ...
          >
            <div className="order-2 md:order-1 relative  ">
              ...
              >
                <img 
                  src="https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4  ">
              <motion.button
                whileHover={{ scale: 1.05, backgroundColor: "#4a6a2f" }}
                whileTap={{ scale: 0.95 }}
                className="!px-8 !py-4 bg-white text-[#5c7c3b] font-bold rounded-lg shadow-lg text-lg  "
              >
                Book Consultation
              </motion.button>
              <motion.button
