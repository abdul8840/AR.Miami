          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="space-y-16 flex flex-col gap-5">
              ...
              <div className="flex gap-4 !ml-13">
                <button className='broder border-2 !py-1 !px-2 sm:!py-2 sm:!px-4 border-[#5c7c3b] text-white font-semibold !mt-10 rounded-lg cursor-pointer bg-[#5c7c3b] hover:bg-white hover:text-black transition-all'>Call Now</button>
