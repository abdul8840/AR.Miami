      ...
      <div className="container mx-auto !px-5 lg:px-0">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 relative">
            <div className="absolute left-4 sm:left-5 h-full w-1 bg-[#023E8A] block"></div>

            <div className="space-y-16 flex flex-col gap-5">
              {steps.map((step, index) => (
                <div key={index} className="flex items-start relative">
                  <div className="w-10 h-10 bg-[#023E8A] rounded-full flex items-center justify-center text-white font-bold z-10 mr-6 shadow-lg">
                    0{index + 1}
                  </div>
              ...
              <div className="flex gap-4 !ml-13">
                <button className='broder border-2 !py-1 !px-2 sm:!py-2 sm:!px-4 border-[#023E8A] text-white font-semibold !mt-10 rounded-lg cursor-pointer bg-[#023E8A] hover:bg-white hover:text-black transition-all'>Call Now</button>
