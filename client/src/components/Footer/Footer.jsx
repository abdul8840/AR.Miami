      ...
      <div className="container mx-auto !px-4 lg:!px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 !mb-8">
          ...
          <div className="!space-y-4">
            <h2 className="text-2xl font-bold text-orange-500">AR.Miami</h2>
            ...
            <div className="flex !space-x-4">
              <Link
                ...
                className="text-white hover:text-orange-500 transition-all transform hover:scale-110"
              >
          ...
          <div className="!space-y-4">
            ...
            <span className="block w-[100px] h-[4px] bg-orange-500 !my-3"></span>
            <ul className="!space-y-2">
              <li>
                <Link
                  to="/services/roof-to-roof"
                  className="text-white hover:text-orange-500 transition-all flex items-center !space-x-2"
                >
                  <FaHammer className="w-4 h-4 text-orange-500" />
              ...
              <li>
                <Link
                  ...
                  className="text-white hover:text-orange-500 transition-all flex items-center !space-x-2"
                >
                  <FaPaintRoller className="w-4 h-4 text-orange-500" />
          ...
          <div className="!space-y-4">
            <h3 className="text-xl font-semibold text-orange-500">Important Links</h3>
            <span className="block w-[100px] h-[4px] bg-orange-500 !my-3"></span>
            <ul className="!space-y-2">
              <li>
                <Link
                  ...
                  className="text-white hover:text-orange-500 transition-all flex items-center !space-x-2"
                >
                  <FaShieldAlt className="w-4 h-4 text-orange-500" />
              ...
              <li>
                <Link
                  ...
                  className="text-white hover:text-orange-500 transition-all flex items-center !space-x-2"
                >
                  <FaFileContract className="w-4 h-4 text-orange-500" />
              ...
              <li>
                <Link
                  ...
                  className="text-white hover:text-orange-500 transition-all flex items-center !space-x-2"
                >
                  <FaBlog className="w-4 h-4 text-orange-500" />
                  <span>Blog</span>
                </Link>
              </li>
            </ul>
          ...
          <div className="!space-y-4">
            ...
            <ul className="!space-y-4">
              <li className="flex items-center !space-x-3">
                <FaPhoneAlt className="text-orange-500 w-5 h-5" />
