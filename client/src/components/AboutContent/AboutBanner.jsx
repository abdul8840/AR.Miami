    ...
    <section className='!py-20 z-100'>
      <div className="container">
        <div className="text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 !mb-4"><span className="inline-block w-[20px] sm:w-[50px] h-[3px] bg-orange-500 !mb-2.5"></span> About Us <span className="inline-block w-[20px] sm:w-[50px] h-[3px] bg-orange-500 !mb-2.5"></span></h2>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center">
          <div className="!p-5 !py-7 w-full lg:w-1/2 order-2 lg:order-1">
            <p className="text-lg text-orange-500 font-semibold mb-2"><span className="inline-block w-[20px] sm:w-[50px] h-[3px] bg-orange-500 !mb-1"></span> Building Today, Inspiring Tomorrow</p>
