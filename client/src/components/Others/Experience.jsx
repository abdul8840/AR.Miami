  ...
  return (
    <section className="!py-12 md:!py-18 aboutbg">
      ...
      <div className="text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white !mb-4"><span className="inline-block w-[20px] sm:w-[50px] h-[3px] bg-[#023E8A] !mb-2.5"></span> Your Vision, Our Expertise <span className="inline-block w-[20px] sm:w-[50px] h-[3px] bg-[#023E8A] !mb-2.5"></span></h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-12 h-12 bg-[#023E8A] flex items-center justify-center">
